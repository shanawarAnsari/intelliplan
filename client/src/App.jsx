...
import {
  ...
  checkSupplyPlanningAccess,
  checkDemandPlanningAccess
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <AuthGuard>
                <FeatureGuard checkFn={checkDemandPlanningAccess}>
          ...
          <Route
            ...
            element={
              <AuthGuard>
                <FeatureGuard checkFn={checkSupplyPlanningAccess}>
          ...
          >
            ...
            >
              <Route index element={<Navigate to="alerts-management" replace />} />
