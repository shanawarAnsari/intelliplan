...
const FeedbackDialog = ({
    ...
    const titleText = type === "helpful" ? "Thanks! What worked well?" : "Sorry! What went wrong?";
        ...
        >
            ...
            <DialogActions sx={{ px: 3, pb: 2 }}>
                ...
                <Button
                    ...
                    disabled={!category}
                    sx={{
                        background: type === "helpful" ? "rgba(16,185,129,0.85)" : "rgba(239,68,68,0.85)",
                        "&:hover": {
                            background: type === "helpful" ? "rgba(16,185,129,1)" : "rgba(239,68,68,1)",
                        },
                    }}
                >
                    Submit
